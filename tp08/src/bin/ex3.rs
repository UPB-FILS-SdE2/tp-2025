...
// TODO 6: define an enum called Protection with 3 items: None, Read and Write
...
extern "C" fn sigsegv_handler(_signal: c_int, siginfo: *mut siginfo_t, _extra: *mut c_void) {
    ...
    // TODO 5: count the number of page faults; lock the page_faults mutex first

    // TODO 6: verify if the page is in the hashmap; lock the pages mutex first
